...
int displayport_make_avi_infoframe_data(u32 sst_id,
...
int displayport_make_audio_infoframe_data(struct infoframe *audio_infoframe,
		struct displayport_audio_config_data *audio_config_data)
{
	int i;
...
int displayport_make_hdr_infoframe_data
...
int displayport_make_spd_infoframe_data(struct infoframe *spd_infoframe)
{
...
int displayport_init_sst_info(struct displayport_device *displayport)
{
	int ret = 0;
	int i = 0;
