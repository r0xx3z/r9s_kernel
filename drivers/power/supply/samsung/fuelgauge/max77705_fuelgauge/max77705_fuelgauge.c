...
int max77705_fg_read_vfsoc(struct max77705_fuelgauge_data *fuelgauge);
...
int max77705_fg_read_vcell(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	u32 vcell, temp;
	u16 w_data;
...
int max77705_fg_read_avg_vcell(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
...
int max77705_fg_check_battery_present(
					struct max77705_fuelgauge_data *fuelgauge)
{
	u8 status_data[2];
	int ret = 1;
...
int max77705_fg_write_temp(struct max77705_fuelgauge_data *fuelgauge,
				  int temperature)
{
	u8 data[2];
...
int max77705_fg_read_temp(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2] = { 0, 0 };
	int temper = 0;
...
int max77705_fg_read_qh_vfsoc(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	int soc;
...
int max77705_fg_read_qh(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	u32 temp, sign;
	s32 qh;
...
/* soc should be 0.1% unit */
int max77705_fg_read_avsoc(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	int soc;
...
/* soc should be 0.1% unit */
int max77705_fg_read_soc(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	int soc;
...
int max77705_fg_read_rawsoc(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	int soc;
...
int max77705_fg_read_fullcap(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	int ret;
...
int max77705_fg_read_fullcaprep(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	int ret;
...
int max77705_fg_read_avcap(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	int ret;
...
int max77705_fg_read_repcap(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	int ret;
...
int max77705_fg_read_current(struct max77705_fuelgauge_data *fuelgauge,
				    int unit)
{
	u8 data1[2];
	u32 temp, sign;
...
int max77705_fg_read_avg_current(struct max77705_fuelgauge_data *fuelgauge,
					int unit)
{
	static int cnt;
	u8 data2[2];
...
int max77705_fg_read_isys(struct max77705_fuelgauge_data *fuelgauge,
					int unit)
{
	u8 data1[2];
	u32 temp = 0;
...
int max77705_fg_read_isys_avg(struct max77705_fuelgauge_data *fuelgauge,
					int unit)
{
	u8 data2[2];
	u32 temp = 0;
...
int max77705_fg_read_iin(struct max77705_fuelgauge_data *fuelgauge,
					int unit)
{
	u8 data1[2];
	u32 temp;
...
int max77705_fg_read_vbyp(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	u32 vbyp, temp;
	u16 w_data;
...
int max77705_fg_read_vsys(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	u32 vsys, temp;
	u16 w_data;
...
int max77705_fg_read_cycle(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 data[2];
	int ret;
...
bool max77705_check_jig_status(struct max77705_fuelgauge_data *fuelgauge)
{
	bool ret = false;
...
int max77705_fg_check_status_reg(struct max77705_fuelgauge_data *fuelgauge)
{
	u8 status_data[2];
	int ret = 0;
...
int max77705_get_fg_soc(struct max77705_fuelgauge_data *fuelgauge)
{
...
void max77705_offset_leakage_default(
				struct max77705_fuelgauge_data *fuelgauge)
{
	// offset coffset
...
unsigned int max77705_fg_get_scaled_capacity(
...
void max77705_lost_soc_reset(struct max77705_fuelgauge_data *fuelgauge)
{
...
void max77705_lost_soc_check_trigger_cond(
...
int max77705_lost_soc_calc_soc(
...
int max77705_lost_soc_get(struct max77705_fuelgauge_data *fuelgauge, int request_soc)
{
...
bool max77705_fg_check_vempty_recover_time(struct max77705_fuelgauge_data *fuelgauge)
{
	struct timespec64 c_ts = {0, };
...
int max77705_get_bat_id(int bat_id[], int bat_gpio_cnt)
{
	int battery_id = 0;
	int i = 0;
