...
int sec_bat_check_afc_input_current(struct sec_battery_info *battery);
void sec_bat_check_input_ocp(struct sec_battery_info *battery, int input_current);
...
int sec_bat_change_iv(void *data, int voltage)
{
	struct sec_battery_info *battery = data;
...
bool sec_bat_change_vbus_pd(struct sec_battery_info *battery)
{
#if defined(CONFIG_SUPPORT_HV_CTRL)
	if (battery->pdata->chg_temp_check_type == SEC_BATTERY_TEMP_CHECK_NONE)
		return false;
...
bool sec_bat_check_by_psy(struct sec_battery_info *battery)
{
	char *psy_name = NULL;
	union power_supply_propval value = {0, };
	bool ret = true;
...
bool sec_bat_get_cable_type(struct sec_battery_info *battery, int cable_source_type)
{
	bool ret = false;
...
bool sec_bat_check_recharge(struct sec_battery_info *battery)
{
...
bool sec_bat_set_aging_step(struct sec_battery_info *battery, int step)
{
	union power_supply_propval value = {0, };
...
bool sec_bat_check_fullcharged_condition(struct sec_battery_info *battery)
{
...
void sec_bat_do_test_function(struct sec_battery_info *battery)
{
	union power_supply_propval value = {0, };
...
void sec_bat_do_fullcharged(struct sec_battery_info *battery, bool force_fullcharged)
{
	union power_supply_propval value = {0, };
...
void sec_bat_get_temperature_info(struct sec_battery_info *battery)
{
	union power_supply_propval value = {0, };
...
bool sec_bat_is_short_polling(struct sec_battery_info *battery)
{
...
int sec_bat_set_polling(struct sec_battery_info *battery)
{
...
void sec_bat_check_slowcharging_work(struct work_struct *work)
{
...
void sec_bat_otg_work(struct work_struct *work)
{
	struct sec_battery_info *battery = container_of(work,
...
void sec_bat_input_check_work(struct work_struct *work)
{
	struct sec_battery_info *battery = container_of(work,
...
int sec_bat_cable_check(struct sec_battery_info *battery,
...
void sec_bat_set_rp_current(struct sec_battery_info *battery, int cable_type)
{
	int icl = 0;
	int fcc = 0;
...
int make_pd_list(struct sec_battery_info *battery)
{
	int i;
...
void sec_bat_parse_param_value(struct sec_battery_info *battery)
{
	int pd_hv_disable = 0;
	union power_supply_propval value = {0, };
